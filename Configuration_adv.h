...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN FAN1        // Set a custom pin for the controller fan
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         1.0 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
